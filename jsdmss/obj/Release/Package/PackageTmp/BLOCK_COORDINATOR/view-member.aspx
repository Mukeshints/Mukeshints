<%@ Page Title="" Language="C#" MasterPageFile="~/BLOCK_COORDINATOR/BlockUser.Master" AutoEventWireup="true" CodeBehind="view-member.aspx.cs" Inherits="jsdmss.BLOCK_COORDINATOR.view_member" EnableEventValidation="false" %>
                    ...
                    <asp:TemplateField HeaderText="id" Visible="False">
                        <ItemTemplate>
                            <asp:Label ID="lbl_id" runat="server" Text='<%#Bind("Id") %>'></asp:Label>
                             <asp:Label ID="lblcoordinater" runat="server" Text='<%#Bind("SubmitedBy") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
