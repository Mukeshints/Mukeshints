<%@ Page Title="" Language="C#" MasterPageFile="~/RMJSY/RMJSY_MASTE.Master" AutoEventWireup="true" CodeBehind="success.aspx.cs" Inherits="jsdmss.RMJSY.success" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" id="success">
        ...
        <div class="row">
            <div class="col-md-12" id="printabledivt" style="margin-top: 10px; margin-bottom: 10px;">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td colspan="3">Correspondance Address : 
