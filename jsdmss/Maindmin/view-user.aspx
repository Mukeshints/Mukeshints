<%@ Page Title="" Language="C#" MasterPageFile="~/Maindmin/User.Master" AutoEventWireup="true" CodeBehind="view-user.aspx.cs" Inherits="jsdmss.Maindmin.view_user" %>
    ...
    <div class="col-md-12">
        <asp:GridView ID="grd_panchyat_cood_list" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="grd_panchyat_cood_list_PageIndexChanging" AllowPaging="True" Font-Bold="False" class="table table-striped table-advance table-hover" Style="margin-top: 0; width: 100%; overflow: scroll">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lnk_deactivate" runat="server" OnClientClick='return confirm("Are you sure want to Deactivate User ?")' CausesValidation="False" ForeColor="Red" Font-Bold="True" Font-Underline="True" OnClick="lnk_deactivate_Click">Deactivate</asp:LinkButton>
