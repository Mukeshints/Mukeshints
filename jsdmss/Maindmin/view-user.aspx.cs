    ...
    public partial class view_user : System.Web.UI.Page
    {
        ...
        protected void lnk_deactivate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                My.executeQuery("Update User_master SET status='DEACTIVE' where Id='" + lblid.Text + "'");
                lbl_message2.Text = "User deactivation process completed successfully.";
                fetch_user("Select * from User_master where status='ACTIVE'");
            }
            catch (Exception exc) { }
