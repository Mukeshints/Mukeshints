<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="jsdmss.Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Jaisheela Devi Memorial Seva Sansthan
</asp:Content>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h3 class="line-bottom">Welcome To <span>Jaisheela Devi Memorial Seva Sansthan</span></h3>
                        <div class="row">
                                ...
                                <div id="nt-example1-container">
                                    <ul id="nt-example1" style="overflow: hidden;">
                                        ...
                                        <li style="margin-top: 0px;">Block selected for the post of BMO interview and certificate verification for Katihar, Pranpur held on 28/01/2021.
                                                    <br />
                                            <span>January, 28, 2021</span> &nbsp; <a href="javascript:" style="color: #e8a94d; font-size: 13px;">
                                                <img src="/RMJSY/images/NEW.gif" />
                                            </a>
                                            <br />
                                        ...
                                        <li style="margin-top: 0px;">Block selected for the post of BMO interview and certificate verification for Manihari, Korha, Kadwa, Barari, Azamnagar, Balrampur, Barsoi, Amdabad held on 27/01/2021 Wednesday.
                                            ...
                                            <br />
                                            <a class="calender-a" href="javascript:">Block selected for the post of BMO interview and certificate verification for Manihari, Korha, Kadwa, Barari, Azamnagar, Balrampur, Barsoi, Amdabad held on 27/01/2021 Wednesday.</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="hom-glry-left-sec">
                            <div class="hom-img-glry-sec">
                                <div class="agileinfo-gallery-row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 w3gallery-grids">
                                            <a href="images/gallery/gallery-ab1.jpg" class="imghvr-hinge-right figure">
                                                ...
                                                <div class="agile-figcaption">
                                                    <h4>Welcome To Jaisheela Devi Memorial Seva Sansthan</h4>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 w3gallery-grids">
                                            <a href="images/gallery/gallery-a9.jpg" class="imghvr-hinge-right figure">
                                               <img src="images/gallery/gallery-a9.jpg" alt="" />
                                                <div class="agile-figcaption">
                                                    <h4>Welcome To Jaisheela Devi Memorial Seva Sansthan</h4>
                                                </div>
                                            </a>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 w3gallery-grids">
                                            <a href="images/gallery/gallery-a10.jpg" class="imghvr-hinge-right figure">
                                               <img src="images/gallery/gallery-a10.jpg" alt="" />
                                                <div class="agile-figcaption">
                                                    <h4>Welcome To Jaisheela Devi Memorial Seva Sansthan</h4>
                                                </div>
                                            </a>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 w3gallery-grids">
                                            <a href="images/gallery/gallery-a11.jpg" class="imghvr-hinge-right figure">
                                                <img src="images/gallery/gallery-a11.jpg" alt="" />
                                                <div class="agile-figcaption">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 w3gallery-grids">
                                            <a href="images/gallery/gallery-a12.jpg" class="imghvr-hinge-right figure">
                                                <img src="images/gallery/gallery-a12.jpg" alt="" />
                                                <div class="agile-figcaption">
